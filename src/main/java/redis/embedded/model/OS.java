...
public enum OS {
    WINDOWS(Architecture::detectWindowsArchitecture), UNIX(Architecture::detectUnixMacOSXArchitecture), MAC_OS_X(Architecture::detectUnixMacOSXArchitecture);
    ...
    public static OS detectOS() {
        ...
        if (osName.contains("nix") || osName.contains("nux") || osName.contains("aix")) return OS.UNIX;
        if ("Mac OS X".equalsIgnoreCase(osName)) return OS.MAC_OS_X;
